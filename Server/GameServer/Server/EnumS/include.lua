...
dofile("./Server/EnumS/PlayerEnum.lua")
dofile("./Server/EnumS/GameEventEnum.lua")
dofile("./Server/EnumS/ItemEnum.lua")
dofile("./Server/EnumS/ChatEnum.lua")
dofile("./Server/EnumS/ShopEnum.lua")
dofile("./Server/EnumS/MailType.lua")
dofile("./Server/EnumS/RankTypeEnum.lua")
dofile("./Server/EnumS/ActionEnum.lua")
