...
local function guild_membernum_duowan(req, method, query, reqbody)
	local resbody = {
		status = 200,
		message = "操作成功",
		data = {},
	...
	if CCenter:Send("CT_PlayerServiceCall", tonumber(reqbody.server), {m_nIndex = nNewIndex, m_sOperName = "yy_guild_membernum",
...
CHttpServer:RegisterHandler("/guild_membernum_duowan", guild_membernum_duowan)
