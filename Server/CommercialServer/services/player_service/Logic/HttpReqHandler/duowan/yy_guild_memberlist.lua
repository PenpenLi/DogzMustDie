...
local function guild_memberlist_duowan(req, method, query, reqbody)
	local resbody = {
		status = 200,
		message = "操作成功",
		data = {},
	...
	if CCenter:Send("CT_PlayerServiceCall", tonumber(reqbody.server), {m_nIndex = nNewIndex, m_sOperName = "yy_guild_memberlist",
...
CHttpServer:RegisterHandler("/guild_memberlist_duowan", guild_memberlist_duowan)
