...
module H52D_Framework {
	...
	export class wxSDKBase {
		private static _inst: wxSDKBase;
		...
		*/
		...
		/**Banner广告 */
		public Establish(adUnitId?: string, w?: number, cb?: any) {
			this.Delete();
			/**获取实际的宽高 */
		...
		/**微信激励视频 */
		public Excitation_Wx(adUnitId?: string, cb?: any) {
			this.Delete();
		...
		/**QQ激励视频 */
		public Excitation_Qq(adUnitId?: string, cb?: any) {
			let videoAd = Wx.createRewardedVideoAd({
				adUnitId: adUnitId
			})
			videoAd.show()
		 ...
		 * 小游戏初始参数
		 */
		public onShow(cb?: any) {
			var ret = Wx.getLaunchOptionsSync();
			if (ret.query) {
				console.log("查询的字串是");
