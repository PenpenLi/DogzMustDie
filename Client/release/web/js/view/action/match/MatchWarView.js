...
(function (H52D_Framework) {
    H52D_Framework.AddViewResource("MatchWarView", [
    ...
    var MatchWarView = /** @class */ (function (_super) {
        __extends(MatchWarView, _super);
        function MatchWarView(buf) {
            ...
            H52D_Framework.MatchLogic.Instance.InitPosInfo();
            ...
            if (H52D_Framework.GetTabLength(H52D_Framework.MatchLogic.Instance.war) == 0) {
                H52D_Framework.MatchLogic.Instance.war = H52D_Framework.MatchLogic.Instance.war;
            }
            // 缓存已有英雄列表
        ...
        /** 拾取英雄 */
        MatchWarView.prototype.DragHero = function (nHeroID, bShowDrag) {
            var _this = this;
            ...
            if (!H52D_Framework.MatchLogic.Instance.IsInWar(nHeroID)) {
        ...
        /** 列表按下事件 */
        MatchWarView.prototype.ListHeadDown = function (nHeroID, item, event) {
            H52D_Framework.Tick.Once(300, this, this.OneListHeadDown, [nHeroID, this.match_listwar._childs[1].value, item, event]);
        };
        /** 列表按下事件 */
        MatchWarView.prototype.OneListHeadDown = function (nHeroID, scrollBarY, item, event) {
            ...
            bool = H52D_Framework.MatchLogic.Instance.IsInWar(nHeroID);
            this.DragHero(nHeroID, bool);
        };
        /** 按住阵容上的英雄 */
        MatchWarView.prototype.CurMouseDown = function (pos) {
            var tPositionWar = H52D_Framework.MatchLogic.Instance.war;
        ...
        /** 鼠标移动事件 */
        MatchWarView.prototype.MouseMove = function (event) {
        ...
        /** 鼠标抬起事件 */
        MatchWarView.prototype.MouseUp = function () {
            ...
            var bool = H52D_Framework.MatchLogic.Instance.IsInSaveWar(nNowPos, nDragHeroID);
            var hero_id = H52D_Framework.MatchLogic.Instance.war[this._opos];
            if (bool) {
                if (hero_id) {
        ...
        MatchWarView.prototype.PutHero = function (nNowPos, nDragHeroID) {
            // 放置英雄
            H52D_Framework.MatchLogic.Instance.PutHero(nNowPos, nDragHeroID);
            H52D_Framework.MatchLogic.Instance.bChange = true;
            this.UpdatePosView();
            this.UpateHeroLsit();
        ...
        /** 获取当前在哪个位置上 */
        MatchWarView.prototype.GetJionPos = function () {
        ...
        /** 打开英雄详情面板 */
        MatchWarView.prototype.OpenView = function (nHeroID) {
            if (this.nDragHeroID != null) {
                return;
            }
        ...
        /** 刷新位置信息 */
        MatchWarView.prototype.UpdatePosView = function (bDrag, bShowDrag) {
            var _this = this;
            var tPositionWar = H52D_Framework.MatchLogic.Instance.war;
        ...
        /** 获取方向和坐标 */
        MatchWarView.prototype.GetDirAndScale = function (nHeroID) {
            var dir = 1;
            var scale = H52D_Framework.HeroConfig[nHeroID].modelScale;
            return [dir, scale];
        };
        MatchWarView.prototype.WarSort = function () {
            function tsort(a, b) {
        ...
        MatchWarView.prototype.UpateHeroLsit = function () {
            this.WarSort();
        ...
        MatchWarView.prototype.SetHandler = function (item, index) {
            ...
            var lv = hero.Level;
            duihao.skin = "";
            var herolist = H52D_Framework.MatchLogic.Instance.HeroWar;
            var a = H52D_Framework.MatchLogic.Instance.IsInWar(nHeroID);
            if (a) {
            ...
            var bool = H52D_Framework.MatchLogic.Instance.IsInWar(nHeroID);
            gowar.visible = bool;
        ...
        /** 点击保存按钮 */
        MatchWarView.prototype.SaveBtnClick = function () {
            var heroposInfo = H52D_Framework.MatchLogic.Instance.war;
            var bool = H52D_Framework.MatchLogic.Instance.bChange;
            ...
            heroposInfo = H52D_Framework.MatchLogic.Instance.getwar();
            ...
            H52D_Framework.MatchLogic.Instance.MatchWarInfo(heroposInfo);
            H52D_Framework.MatchLogic.Instance.bChange = false;
        };
        MatchWarView.prototype.IsQuit = function () {
            return true;
        };
        /**关闭按钮 弹出提示框 */
        MatchWarView.prototype.Btn_Close = function () {
            var _this = this;
            var heroposInfo = H52D_Framework.MatchLogic.Instance.war;
            var bool = H52D_Framework.MatchLogic.Instance.bChange;
            if (heroposInfo[4] == null) {
            ...
            if (H52D_Framework.MatchLogic.Instance.bChange) {
                ...
                H52D_Framework.TipsLogic.Instance.OpenMessageBox(str, Laya.Handler.create(this, function () {
                    _this.SaveBtnClick();
                    H52D_Framework.UIManager.Instance.DestroyUI("MatchWarView", [_this.parent]);
                }), Laya.Handler.create(this, function () {
                    H52D_Framework.UIManager.Instance.DestroyUI("MatchWarView", [_this.parent]);
                }));
            }
            else {
                H52D_Framework.UIManager.Instance.DestroyUI("MatchWarView", [this.parent]);
                //Event.DispatchEvent("ReshView_ladder");
            }
        };
        /***播放特效 */
        MatchWarView.prototype.WarEffect = function (pos) {
            var _this = this;
        ...
        /**设置队长技能图片 */
        MatchWarView.prototype.SetMainskillIcon = function (nHeroID) {
            if (nHeroID) {
                this.L.visible = true;
        ...
        return MatchWarView;
    }(ui.action.match.MatchWarViewUI));
    H52D_Framework.MatchWarView = MatchWarView;
})(H52D_Framework || (H52D_Framework = {}));
//# sourceMappingURL=MatchWarView.js.map