...
(function (H52D_Framework) {
    H52D_Framework.AddViewResource("MemoryWarView", [
    ...
    var MemoryWarView = /** @class */ (function (_super) {
        __extends(MemoryWarView, _super);
        function MemoryWarView(buf) {
            ...
            H52D_Framework.MemoryLogic.Instance.InitPosInfo();
            ...
            if (H52D_Framework.GetTabLength(H52D_Framework.MemoryLogic.Instance.war) == 0) {
                H52D_Framework.MemoryLogic.Instance.war = H52D_Framework.MemoryLogic.Instance.war;
            }
            // 缓存已有英雄列表
        ...
        /** 拾取英雄 */
        MemoryWarView.prototype.DragHero = function (nHeroID, bShowDrag) {
            var _this = this;
            ...
            if (!H52D_Framework.MemoryLogic.Instance.IsInWar(nHeroID)) {
        ...
        /** 列表按下事件 */
        MemoryWarView.prototype.ListHeadDown = function (nHeroID, item, event) {
            H52D_Framework.Tick.Once(300, this, this.OneListHeadDown, [nHeroID, this.memory_listwar._childs[1].value, item, event]);
        };
        /** 列表按下事件 */
        MemoryWarView.prototype.OneListHeadDown = function (nHeroID, scrollBarY, item, event) {
            if (this.memory_listwar._childs[1].value != scrollBarY) {
                return;
            }
            var bool = false;
            this.dragHeroIcon.x = this.memory_listwar.x + item.x + 120;
            this.dragHeroIcon.y = this.memory_listwar.y + item.y - this.memory_listwar._childs[1].value + 120;
            this.memory_listwar._childs[0];
            this.memory_listwar.scrollBar.stopDrag();
            this.memory_listwar.scrollBar.stopScroll();
            bool = H52D_Framework.MemoryLogic.Instance.IsInWar(nHeroID);
            this.DragHero(nHeroID, bool);
        };
        /** 按住阵容上的英雄 */
        MemoryWarView.prototype.CurMouseDown = function (pos) {
            var tPositionWar = H52D_Framework.MemoryLogic.Instance.war;
        ...
        /** 鼠标移动事件 */
        MemoryWarView.prototype.MouseMove = function (event) {
        ...
        /** 鼠标抬起事件 */
        MemoryWarView.prototype.MouseUp = function () {
            ...
            var bool = H52D_Framework.MemoryLogic.Instance.IsInSaveWar(nNowPos, nDragHeroID);
            var hero_id = H52D_Framework.MemoryLogic.Instance.war[this._opos];
            if (bool) {
                if (hero_id) {
        ...
        MemoryWarView.prototype.PutHero = function (nNowPos, nDragHeroID) {
            // 放置英雄
            H52D_Framework.MemoryLogic.Instance.PutHero(nNowPos, nDragHeroID);
            H52D_Framework.MemoryLogic.Instance.bChange = true;
            this.UpdatePosView();
            this.UpateHeroLsit();
        ...
        /** 获取当前在哪个位置上 */
        MemoryWarView.prototype.GetJionPos = function () {
        ...
        /** 打开英雄详情面板 */
        MemoryWarView.prototype.OpenView = function (nHeroID) {
            if (this.nDragHeroID != null) {
                return;
            }
        ...
        /** 刷新位置信息 */
        MemoryWarView.prototype.UpdatePosView = function (bDrag, bShowDrag) {
            var _this = this;
            var tPositionWar = H52D_Framework.MemoryLogic.Instance.war;
        ...
        /** 获取方向和坐标 */
        MemoryWarView.prototype.GetDirAndScale = function (nHeroID) {
            var dir = 1;
            var scale = H52D_Framework.HeroConfig[nHeroID].modelScale;
            return [dir, scale];
        };
        MemoryWarView.prototype.WarSort = function () {
            function tsort(a, b) {
        ...
        MemoryWarView.prototype.UpateHeroLsit = function () {
            this.WarSort();
            this.memory_listwar.array = this._HasHeroList;
            this.memory_listwar.vScrollBarSkin = "";
            this.memory_listwar.renderHandler = new Laya.Handler(this, this.SetHandler);
        };
        MemoryWarView.prototype.SetHandler = function (item, index) {
            ...
            var lv = hero.Level;
            duihao.skin = "";
            var herolist = H52D_Framework.MemoryLogic.Instance.HeroWar;
            var a = H52D_Framework.MemoryLogic.Instance.IsInWar(nHeroID);
            if (a) {
            ...
            var bool = H52D_Framework.MemoryLogic.Instance.IsInWar(nHeroID);
            gowar.visible = bool;
        ...
        /** 点击保存按钮 */
        MemoryWarView.prototype.SaveBtnClick = function () {
            var heroposInfo = H52D_Framework.MemoryLogic.Instance.war;
            var bool = H52D_Framework.MemoryLogic.Instance.bChange;
            ...
            heroposInfo = H52D_Framework.MemoryLogic.Instance.getwar();
            ...
            H52D_Framework.MemoryLogic.Instance.K_SaveCopyBattleArray(this._eTpye, heroposInfo);
            H52D_Framework.MemoryLogic.Instance.bChange = false;
        };
        MemoryWarView.prototype.IsQuit = function () {
            return true;
        };
        /**关闭按钮 弹出提示框 */
        MemoryWarView.prototype.Btn_Close = function () {
            var _this = this;
            var heroposInfo = H52D_Framework.MemoryLogic.Instance.war;
            var bool = H52D_Framework.MemoryLogic.Instance.bChange;
            if (heroposInfo[4] == null) {
            ...
            if (H52D_Framework.MemoryLogic.Instance.bChange) {
                ...
                H52D_Framework.TipsLogic.Instance.OpenMessageBox(str, Laya.Handler.create(this, function () {
                    _this.SaveBtnClick();
                    H52D_Framework.UIManager.Instance.DestroyUI("MemoryWarView", [H52D_Framework.ViewToppestRoot]);
        ...
        /***播放特效 */
        MemoryWarView.prototype.WarEffect = function (pos) {
            var _this = this;
        ...
        /**设置队长技能图片 */
        MemoryWarView.prototype.SetMainskillIcon = function (nHeroID) {
            if (nHeroID) {
                this.L.visible = true;
        ...
        return MemoryWarView;
    }(ui.action.memory.MemoryWarViewUI));
    H52D_Framework.MemoryWarView = MemoryWarView;
})(H52D_Framework || (H52D_Framework = {}));
//# sourceMappingURL=MemoryWarView.js.map